...
public class AttractionsFragment extends Fragment {
    ...
    private CollectionReference myCollection = db.collection("attractions")
            .document("KPCFmFqaRf9GdhlpO45J").collection("site");
    private View v;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FirestoreRecyclerOptions<ModelClass> options = new FirestoreRecyclerOptions.Builder<ModelClass>()
                .setQuery(myCollection, ModelClass.class).build();
